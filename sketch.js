...
var keysGroup, coinsGroup, virusGroup, vaccineGroup;
...
function setup(){
   canvas = createCanvas(displayWidth - 50, displayHeight - 200);
    ...
    ground = createSprite((displayWidth - 50)/2,(displayHeight - 200),displayWidth - 50,20);
...
function spawnKeys() {
    if(frameCount % 500 === 0) {
      ...
      keys.velocityX = -4;
      keys.y = Math.round(random(displayHeight - 550,displayHeight - 750));
